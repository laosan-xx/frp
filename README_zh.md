...
frp 是一个完全开源的项目，我们的开发工作完全依靠赞助者们的支持。如果你愿意加入他们的行列，请考虑 [赞助 frp 的开发](https://github.com/sponsors/laosan-xx)。
...
* 如果你有任何其他方面的问题或合作，欢迎发送邮件至 laosan-xx@gmail.com 。
...
您可以通过 [GitHub Sponsors](https://github.com/sponsors/laosan-xx) 赞助我们。

国内用户可以通过 [爱发电](https://afdian.com/a/laosan-xx) 赞助我们。
